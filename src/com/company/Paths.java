...
class MyDataBase{
	public static Map<String,ArrayList<String>> defaultDataBase(){
        DataBase.insert("Bangalore", "Singapore");
        DataBase.insert("Singapore", "Dubai");
		DataBase.insert("Singapore", "Seoul");
		DataBase.insert("Seoul", "Beijing");
		DataBase.insert("Beijing", "Tokyo");
		DataBase.insert("Dubai", "Finland");
