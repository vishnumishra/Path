...
public class PathsTest {
   ...
   public  void getPath_give_the_path_between_Bangalore_to_Tokyo(){
    ...
    @Test
    public void getDBFromFile_create_data_base_from_file_01() throws Exception {
        p=new Paths();
        p.db = DataBase.getDBFromFile("src/com/company/Paths.txt");
    ...
    @Test
    public void getDBFromFile_create_data_base_from_file_02() throws Exception {
        p=new Paths();
        p.db = DataBase.getDBFromFile("src/com/company/Paths.txt");
        assertEquals(p.db.containsKey("Singapore"),true);
    }
...
//    }
    @Test
    public  void getPath_is_working_for_file_data_base_02() throws Exception {
        p=new Paths();
        p.db = DataBase.getDBFromFile("src/com/company/Paths.txt");
        String path = p.getPath("Bangalore","Singapore");
        assertEquals("Bangalore==>Singapore",path);
